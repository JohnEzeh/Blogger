...
import com.example.blogger.CommentActivity;
import com.example.blogger.R;
import com.example.blogger.fragments.PostDetailFragment;
import com.example.blogger.fragments.ProfileFragment;
import com.example.blogger.model.Post;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (post.getDescription().equals("")){
            ...
            //WHERE I CALLED ALL MY METHODS/g
        ...
        ///dsdvfsffs
        holder.is_like.setOnClickListener(view -> {
